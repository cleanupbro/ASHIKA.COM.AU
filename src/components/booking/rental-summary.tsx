...
export function RentalSummary({
  ...
  return (
    <div className="bg-brand-cream rounded-xl p-4 space-y-4">
      <h4 className="font-medium text-brand-black">Rental Timeline</h4>

      <div className="space-y-3">
        {/* Ship by date */}
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
            <Package className="w-4 h-4 text-brand-black" />
          </div>
          <div>
        ...
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
            <RotateCcw className="w-4 h-4 text-brand-black" />
          </div>
          <div>
        ...
        <div className="pt-4 border-t border-gray-200 space-y-2">
          ...
          <div className="pt-2 border-t border-gray-200">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-brand-black">${rentalPrice}</span>
            </div>
